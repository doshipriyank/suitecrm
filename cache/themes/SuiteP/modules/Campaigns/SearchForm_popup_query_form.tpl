...
<input class="date_input" autocomplete="off" type="text" name="{$fields.start_date_advanced.name}" id="{$fields.start_date_advanced.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.end_date_advanced.name}" id="{$fields.end_date_advanced.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
