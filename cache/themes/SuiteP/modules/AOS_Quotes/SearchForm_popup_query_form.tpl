...
<input class="date_input" autocomplete="off" type="text" name="{$fields.expiration_advanced.name}" id="{$fields.expiration_advanced.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
    <button type="button" id="{$fields.expiration_advanced.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.expiration_advanced.name}",
form : "popup_query_form",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.expiration_advanced.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
